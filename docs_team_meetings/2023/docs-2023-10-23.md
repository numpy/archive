...
# 2023-10-23 NumPy Documentation Team meeting
...
- Next meeting: 2023-11-06 @ 11PM UTC
...
**Present:** Mukulika, Mars, Brigitta
...
- Mars talk 'Comics in NumPy? More Likely Than you Think!' accepted at PyData NYC!
    - [Link to talk outline](https://nyc2023.pydata.org/cfp/talk/MTUFNQ/)
...
- [Pages](https://www.notion.so/Meeting-with-Mukulika-31fa308b0209478da6be24949c5c9b2b)
    - 10/16 pages rougly done for SciPy NYC
    - Need to make cover and back cover
    - Cover
        - Inspired from page 5
    - Back cover
        - Explain comics are not complete for PyData NYC
        - What future pages will have
        - Credits
        - Where to find the artist
    - Feedback 
        - For now, since plan on finalizing for printing in a few days, Mukulika can help check for typos
        - Bigger comments and feedback will be given after the talk
    - Promotion
        - Already a little this week and next week, Oct 30
    - **Previous steps**:
        - Review #2 (August)
        - Review #1 (July)
