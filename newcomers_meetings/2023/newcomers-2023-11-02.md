# 2023-11-02 NumPy Newcomers' Hour
...
**Present** *(add your name and GitHub handle)*:
Inessa, Ganesh, Megha, Yashaswi
...
### MEETING NOTES
- Discussed how to setup NumPy
- Had a code walkthrough using code spaces
- Needed additional setup for Open BLAS, followed https://hackmd.io/g5gtLntUQx-Lanhi55SdJQ
- Showed `build`, `test`, `doc` command
___
...
- [Building the NumPy documentation](https://numpy.org/devdocs/dev/howto_build_docs.html)
