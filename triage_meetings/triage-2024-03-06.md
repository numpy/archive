...
# 2024-03-06 NumPy triage meeting
...
**Present**: Matti Picus, Nathan Goldbaum, Mateusz Sokol, Chuck Harris, Tyler Reddy, Chris Sidebottom, Ralf Gommers, Sayed Adel, Ross Barnowski, Peter Eendebak, Sebastian Berg
...
- Let's add a second NULL reserved slot to the dtype PR.

- The linalg solve API change/cleanup:
  - Let's just merge it (or fix that tiny typo). 

- Sorting issue https://github.com/numpy/numpy/issues/25464 is still a problem?
