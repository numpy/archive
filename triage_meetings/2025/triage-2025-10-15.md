...
- Add Plausable analytics to the NumPy docs: https://github.com/numpy/numpy/pull/29892. Inessa will send a message to the mailing list that we merged the PR and planning to make the dashboards public.
