...
# 2025-06-11 NumPy triage meeting
...
**Present**: Sebastian, Chuck, Tyler Reddy, Ben Woodruff, Riley Rockwell, Sayed, Joao Gomes, Nathan Goldbaum
...
- (mattip) There are over 240 open PRs. Could the maintainers take a look at their open ones? Should we cull some of the ~100 PRs marked as "enhancements"?
  ...
  - PRs that are in draft mode and over a year old can generally be closed. 

## Action items

- Apple fix should be forthcoming (but timeline is a bit unclear)

- Sayed making nice progress on https://github.com/numpy/numpy-simd-routines/pull/1
