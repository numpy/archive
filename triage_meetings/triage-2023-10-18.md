...
# 2023-10-18 NumPy triage meeting
...
**Present**: Sebastian Berg, Nathan, Tyler Reddy, Ross Barnowski, Chuck Harris, Nathan Goldbaum, Chris, Raghuveer Devulapalli
...
- Building against pre-releases `PIP_PRE=1` or `--pre` (or `--no-built isolation`).
