...
# 2026-07-22 NumPy triage meeting
...
**Present**: Manaas, Charles, Nathan, Matti, Sam
...
- Discussed limiting new contributors to submitting 1–2 PRs at a time. Agreed that this proposal requires further discussion on the mailing list before any decision is made.
   ...
   - After a short dicussion 22.7 we decided to move forward, maybe add an agent.md and claude.md
...
- Review PRs labeled **Close?**:
https://github.com/numpy/numpy/issues?q=state:open+label%3A%2257+-+Close%3F%22
