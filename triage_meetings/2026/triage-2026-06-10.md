...
# 2026-06-10 NumPy triage meeting
...
**Present**: Sebastian, Honi, Nathan, Joren, Tyler, Sam, Chuck, Maanas, Iason, Alex Choi, Sayed
...
* Iason working on a new reduce for minmax, discussions around that ()

* Nathan: will talk to Python SC and at EuroPython dev summit.
  * Borrow checking for rust
  * Hopefull also custom extended/dtypes
  * Sebastian: Could mention possible device support (but careful, because we don't want to overload :)
