...
# 2023-04-05 NumPy triage meeting
...
**Present** *(add your name and GitHub handle)*: Tyler, Sebastian, Sayed, Ross, Raghuveer, Inessa
...
- Inessa: NumPy 2.0 recording

- Inessa: ENH: drop dtype metadata: https://github.com/numpy/numpy/pull/23371

- NumPy 2.0 deprecations info

Big changes: NEP
Roadmap: smaller changes (e.g., Array API)
Deprecations: release notes

Long double isn't an easy deprecation. We should consider offering alternatives to users who depend on it.
