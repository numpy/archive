...
# 2024-03-20 NumPy triage meeting
...
**Present**: Nathan, Matti, Alexander (2d fft contributor), Tyler, Chuck, Raghuveer, Michael Haas
...
## New topics
- [2d FFT](https://mail.python.org/archives/list/numpy-discussion@python.org/thread/CYFXHY4HUZ27YDZNM5S5LPOTYH3M2FHG/) - Alexander presented the idea and wondered how he should move forward. 

- Let's talk about `intp` https://github.com/numpy/numpy/issues/26092


## Action items

- The C-API import warning needs to be escalated:
  - Let's do that for the RC release and the beta will stay with a warning.

- Sorting issue https://github.com/numpy/numpy/issues/25464 about sorting with Highway crashing on arm64. It has been mitigated but not solved.
